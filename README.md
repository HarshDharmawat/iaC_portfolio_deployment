...
3.  **The Mechanic (`deploy-app.yml`):** Connects to the EC2 instance via SSH, installs Docker/AWS CLI, authenticates with ECR using credential-less IAM roles, pulls the latest image, and restarts the container with zero manual intervention.
